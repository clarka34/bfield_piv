...
OPTIONS.parallel_nCPUs   = 4;               % enter the number of CPUs to use in parallel, or enter 'false' or 1 to run without the Parallel Toolbox
...
OPTIONS.overlap          = 0.5;          	% overlap of windsow/interrogation regions
...
%% BEST LUCK and HAPPY PIV, run the entire toolchain now: piv_bfield(OPTIONS, dir_case);
